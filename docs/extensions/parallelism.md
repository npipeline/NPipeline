...
For complete validation documentation, see [Parallel Configuration Rule Details](../core-concepts/pipeline-validation.md#parallel-configuration-rule-details).
