...
/// <summary>
///     Entry point for the AggregateNode sample demonstrating real-time analytics dashboard scenarios.
///     This sample shows tumbling windows, sliding windows, and aggregation patterns for analytics metrics.
/// </summary>
public sealed class Program
{
    public static async Task Main(string[] args)
    {
        Console.WriteLine("=== NPipeline Sample: AggregateNode for Real-Time Analytics ===");
        Console.WriteLine();
        ...
        try
        {
            ...
            Console.WriteLine(AggregateNodePipeline.GetDescription());
            Console.WriteLine();
            ...
            await host.Services.RunPipelineAsync<AggregateNodePipeline>();
