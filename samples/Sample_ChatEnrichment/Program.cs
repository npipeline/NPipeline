...
namespace Sample_ChatEnrichment;
...
public sealed class EnrichedCommentSink : SinkNode<Comment>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await foreach (var comment in input.WithCancellation(cancellationToken))
        {
            ...
            Console.WriteLine(comment.Text.Length > 48
                ? comment.Text[..45] + "..."
                : comment.Text);
        }
...
public sealed class SentimentEnrichPipeline : IPipelineDefinition
{
    public void Define(PipelineBuilder builder, PipelineContext context)
    {
        ...
        var aiEnrich = builder.AddChatEnrichment<Comment, SentimentResult>(chatClient, options => options
...
public static class Program
{
    ...
    {
        Console.WriteLine("=== NPipeline Chat Enrichment Sample ===");
        Console.WriteLine("  SentimentEnrichPipeline: CommentSource -> ChatEnrichment -> EnrichedCommentSink");
