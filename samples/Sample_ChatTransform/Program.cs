...
namespace Sample_ChatTransform;
...
public sealed class ClassificationPipeline : IPipelineDefinition
{
    public void Define(PipelineBuilder builder, PipelineContext context)
    {
        ...
        var aiTransform = builder.AddChatTransform<Comment, ClassificationResult>(chatClient, options => options
...
public static class Program
{
    ...
    {
        Console.WriteLine("=== NPipeline Chat Transform Sample ===");
        Console.WriteLine("  ClassificationPipeline: CommentSource -> ChatTransform -> ClassificationSink");
