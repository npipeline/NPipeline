...
namespace Sample_CustomNodeImplementation.Nodes;
...
public class CachedTransform : TransformNode<SensorData, ProcessedSensorData>, IAsyncDisposable
{
    ...
    public override async ValueTask<ProcessedSensorData> TransformAsync(SensorData item, PipelineContext context, CancellationToken cancellationToken)
    {
        _processedCount++;
