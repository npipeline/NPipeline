...
///     This demonstrates data transformation capabilities for Excel data with various data types.
/// </summary>
public class DataTransform : TransformNode<Customer, Customer>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var transformedCustomer = new Customer
        {
            ...
            DiscountPercentage = NormalizeDiscount(input.DiscountPercentage),
        ...
        return ValueTask.FromResult<Customer>(transformedCustomer);
    }
    ...
    /// <summary>
    ///     Normalizes the discount percentage to ensure it's within valid bounds.
    /// </summary>
