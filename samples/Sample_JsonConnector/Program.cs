...
/// <summary>
///     Entry point for the JSON Connector sample demonstrating JSON data processing with NPipeline.
///     This sample shows how to read from JSON files, validate and transform data, and write to JSON files.
/// </summary>
public sealed class Program
{
    public static async Task Main(string[] args)
    {
        Console.WriteLine("=== NPipeline Sample: JSON Connector ===");
        Console.WriteLine();
        ...
        try
        {
            ...
            Console.WriteLine(JsonConnectorPipeline.GetDescription());
            Console.WriteLine();
            ...
            {
                ["SourcePath"] = Path.Combine(projectDir, "Data", "customers.json"),
                ["TargetPath"] = Path.Combine(projectDir, "Data", "processed_customers.json"),
            };
            ...
            await host.Services.RunPipelineAsync<JsonConnectorPipeline>(pipelineParameters);
