...
```bash
dotnet run --project Sample_KeyedJoinNode
```
...
- [Sample 10: Complex Data Transformations](../Sample_ComplexDataTransformations/) - Advanced join patterns
- [Sample 12: Batching Node](../Sample_BatchingNode/) - Stream processing patterns
- [Sample 11: CSV Connector](../Sample_CsvConnector/) - External data integration
