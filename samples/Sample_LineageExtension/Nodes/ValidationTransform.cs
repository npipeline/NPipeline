...
public class ValidationTransform : TransformNode<EnrichedOrder, ValidatedOrder>
{
    ...
    public override ValueTask<ValidatedOrder> TransformAsync(EnrichedOrder enrichedOrder, PipelineContext context, CancellationToken cancellationToken)
    {
        ...
        return ValueTask.FromResult<ValidatedOrder>(validatedOrder);
    }
}
