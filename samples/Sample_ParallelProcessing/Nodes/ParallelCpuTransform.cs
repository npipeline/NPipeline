...
public class ParallelCpuTransform : TransformNode<CpuIntensiveWorkItem, ProcessedWorkItem>
{
    ...
    public override async ValueTask<ProcessedWorkItem> TransformAsync(CpuIntensiveWorkItem item, PipelineContext context, CancellationToken cancellationToken)
    {
