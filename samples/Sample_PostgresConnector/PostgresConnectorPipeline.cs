...
/// </summary>
public sealed class PostgresConnectorPipeline
{
    private readonly string _connectionString;

    /// <summary>
    ///     Initializes a new instance of the <see cref="PostgresConnectorPipeline" /> class.
    /// </summary>
    /// <param name="connectionString">The PostgreSQL connection string.</param>
    public PostgresConnectorPipeline(string connectionString)
    {
