...
public sealed class CancellationTokenRespectAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor CancellationTokenNotRespectedRule = new(
        ...
        true,
        "Cancellation tokens should be passed to async operations and checked periodically to ensure responsive cancellation. This helps prevent hanging operations and improves application responsiveness.");
