...
public sealed class LinqInHotPathsAnalyzer : DiagnosticAnalyzer
{
    ...
    /// </summary>
    public const string DiagnosticId = "NP9205";
    ...
    private static void AnalyzeInvocationExpression(SyntaxNodeAnalysisContext context)
    {
        ...
        // Small trace left for debugging; avoid noisy output in test runs.
        // Console.WriteLine is intentionally minimized in production analyzers.
        ...
        if (!IsInHotPathContext(invocation, semanticModel, out var enclosingMethodName))
            return;
    ...
    private static bool IsLinqMethod(InvocationExpressionSyntax invocation, SemanticModel semanticModel)
    {
        ...
        // Debug trace (temporary): print method name being analyzed
        try
        {
        }
        catch
