...
/// <summary>
///     Redshift implementation of IDatabaseCommand.
///     Wraps NpgsqlCommand for database-agnostic operations.
/// </summary>
internal sealed class RedshiftDatabaseCommand : IDatabaseCommand
{
    private readonly NpgsqlCommand _command;

    /// <summary>
    ///     Initializes a new instance of the <see cref="RedshiftDatabaseCommand" /> class.
    /// </summary>
    /// <param name="command">The Npgsql command to wrap.</param>
    public RedshiftDatabaseCommand(NpgsqlCommand command)
    {
    ...
    public async Task<IDatabaseReader> ExecuteReaderAsync(CancellationToken cancellationToken = default)
    {
        ...
        return new RedshiftDatabaseReader(reader);
    }
