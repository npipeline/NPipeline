...
namespace NPipeline.Connectors.DataLake.Snapshot
{
    ...
    public sealed class TableSnapshot
    {
            ...
            StorageUri tableBasePath)
        {
            ...
            EarliestWrittenAt = _entries.Count > 0 ? _entries.Min(e => e.WrittenAt) : DateTimeOffset.MinValue;
            LatestWrittenAt = _entries.Count > 0 ? _entries.Max(e => e.WrittenAt) : DateTimeOffset.MinValue;
        }
