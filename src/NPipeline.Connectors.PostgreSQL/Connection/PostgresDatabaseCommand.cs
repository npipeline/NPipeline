...
/// <summary>
///     PostgreSQL implementation of IDatabaseCommand.
///     Wraps NpgsqlCommand for database-agnostic operations.
/// </summary>
internal sealed class PostgresDatabaseCommand(NpgsqlCommand command) : IDatabaseCommand
{
    private readonly NpgsqlCommand _command = command ?? throw new ArgumentNullException(nameof(command));
