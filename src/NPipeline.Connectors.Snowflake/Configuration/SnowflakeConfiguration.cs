...
public class SnowflakeConfiguration
{
    ...
    /// <summary>
    ///     Gets or sets how writes are retried. Defaults to <see cref="SnowflakeConnectorResilience.Default" />: four
    ///     attempts with exponential backoff, retrying only the errors <see cref="SnowflakeConnectorResilience.Classifier" />
