...
/// <summary>
///     Abstraction for Snowflake connection pool management.
///     Provides connection lifecycle management and SnowflakeDbConnection access.
/// </summary>
public interface ISnowflakeConnectionPool : IAsyncDisposable
{
    /// <summary>
    ...
    Task<SnowflakeDbConnection> GetConnectionAsync(CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>An open SnowflakeDbConnection.</returns>
    Task<SnowflakeDbConnection> GetConnectionAsync(string name, CancellationToken cancellationToken = default);
