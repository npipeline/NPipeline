...
/// <summary>
///     Provides typed, cached access to a Snowflake data row.
///     Handles Snowflake's uppercase column name convention.
/// </summary>
public sealed class SnowflakeRow
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="SnowflakeRow" /> class.
    /// </summary>
    /// <param name="reader">The underlying data reader.</param>
    /// <param name="caseInsensitive">Whether to perform case-insensitive column lookups. Default true for Snowflake.</param>
    public SnowflakeRow(IDatabaseReader reader, bool caseInsensitive = true)
    {
