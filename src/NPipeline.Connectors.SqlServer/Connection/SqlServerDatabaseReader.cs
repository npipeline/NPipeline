...
/// <summary>
///     SQL Server implementation of IDatabaseReader.
///     Wraps SqlDataReader for database-agnostic operations.
/// </summary>
internal sealed class SqlServerDatabaseReader(SqlDataReader reader) : IDatabaseReader
{
    internal SqlDataReader Reader { get; } = reader ?? throw new ArgumentNullException(nameof(reader));
