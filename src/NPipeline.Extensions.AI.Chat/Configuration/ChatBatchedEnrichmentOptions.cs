...
/// <summary>Configuration options for <see cref="Nodes.ChatBatchedEnrichmentNode{TIn, TField}" />.</summary>
...
public sealed record ChatBatchedEnrichmentOptions<TIn, TField>(
...
/// <summary>Fluent builder for <see cref="ChatBatchedEnrichmentOptions{TIn, TField}" />.</summary>
/// <typeparam name="TIn">The input item type.</typeparam>
/// <typeparam name="TField">The AI-generated field type.</typeparam>
public sealed class ChatBatchedEnrichmentOptionsBuilder<TIn, TField>
{
    ...
    public ChatBatchedEnrichmentOptionsBuilder<TIn, TField> WithSystemPrompt(string systemPrompt)
    {
    ...
    public ChatBatchedEnrichmentOptionsBuilder<TIn, TField> WithBatchTemplate(Func<IReadOnlyCollection<TIn>, string> batchTemplate)
    {
    ...
    public ChatBatchedEnrichmentOptionsBuilder<TIn, TField> WithResultMapper(ResultMapper<TIn, TField> resultMapper)
    {
    ...
    public ChatBatchedEnrichmentOptionsBuilder<TIn, TField> WithTemperature(float temperature)
    {
    ...
    public ChatBatchedEnrichmentOptionsBuilder<TIn, TField> WithMaxOutputTokens(int maxOutputTokens)
    {
    ...
    public ChatBatchedEnrichmentOptionsBuilder<TIn, TField> WithNativeStructuredOutput(bool useNativeStructuredOutput = true)
    {
    ...
    public ChatBatchedEnrichmentOptionsBuilder<TIn, TField> WithConfigureOptions(Action<ChatOptions> configureOptions)
    {
    ...
    public ChatBatchedEnrichmentOptions<TIn, TField> Build()
    {
        ...
        return new ChatBatchedEnrichmentOptions<TIn, TField>(
            _systemPrompt,
            _batchTemplate,
            _resultMapper,
            _temperature,
