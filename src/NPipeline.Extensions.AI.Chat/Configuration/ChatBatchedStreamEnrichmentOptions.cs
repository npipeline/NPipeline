...
/// <summary>Configuration options for <see cref="Nodes.ChatBatchedStreamEnrichmentNode{TIn, TField}" />.</summary>
...
public sealed record ChatBatchedStreamEnrichmentOptions<TIn, TField>(
...
/// <summary>Fluent builder for <see cref="ChatBatchedStreamEnrichmentOptions{TIn, TField}" />.</summary>
/// <typeparam name="TIn">The input item type.</typeparam>
/// <typeparam name="TField">The AI-generated field type.</typeparam>
public sealed class ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField>
{
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithSystemPrompt(string systemPrompt)
    {
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithBatchTemplate(Func<IReadOnlyCollection<TIn>, string> batchTemplate)
    {
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithResultMapper(ResultMapper<TIn, TField> resultMapper)
    {
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithTemperature(float temperature)
    {
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithMaxOutputTokens(int maxOutputTokens)
    {
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithNativeStructuredOutput(bool useNativeStructuredOutput = true)
    {
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithConfigureOptions(Action<ChatOptions> configureOptions)
    {
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithBatchSize(int batchSize)
    {
        if (batchSize <= 0)
    ...
    public ChatBatchedStreamEnrichmentOptionsBuilder<TIn, TField> WithBatchTimeout(TimeSpan batchTimeout)
    {
    ...
    public ChatBatchedStreamEnrichmentOptions<TIn, TField> Build()
    {
        ...
        return new ChatBatchedStreamEnrichmentOptions<TIn, TField>(
            _systemPrompt,
            _batchTemplate,
            _resultMapper,
            _temperature,
