...
/// <summary>Configuration options for <see cref="Nodes.ChatBatchedStreamTransformNode{TIn, TOut}" />.</summary>
...
public sealed record ChatBatchedStreamTransformOptions<TIn, TOut>(
...
/// <summary>Fluent builder for <see cref="ChatBatchedStreamTransformOptions{TIn, TOut}" />.</summary>
/// <typeparam name="TIn">The input item type.</typeparam>
/// <typeparam name="TOut">The output item type.</typeparam>
public sealed class ChatBatchedStreamTransformOptionsBuilder<TIn, TOut>
{
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithSystemPrompt(string systemPrompt)
    {
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithBatchTemplate(Func<IReadOnlyCollection<TIn>, string> batchTemplate)
    {
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithTemperature(float temperature)
    {
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithMaxOutputTokens(int maxOutputTokens)
    {
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithNativeStructuredOutput(bool useNativeStructuredOutput = true)
    {
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithConfigureOptions(Action<ChatOptions> configureOptions)
    {
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithBatchSize(int batchSize)
    {
        if (batchSize <= 0)
    ...
    public ChatBatchedStreamTransformOptionsBuilder<TIn, TOut> WithBatchTimeout(TimeSpan batchTimeout)
    {
    ...
    public ChatBatchedStreamTransformOptions<TIn, TOut> Build()
    {
        ...
        return new ChatBatchedStreamTransformOptions<TIn, TOut>(
            _systemPrompt,
            _batchTemplate,
            _temperature,
            _maxOutputTokens,
