...
/// <summary>Configuration options for <see cref="Nodes.ChatEnrichmentNode{TIn, TField}" />.</summary>
...
public sealed record ChatEnrichmentOptions<TIn, TField>(
...
/// <summary>Fluent builder for <see cref="ChatEnrichmentOptions{TIn, TField}" />.</summary>
/// <typeparam name="TIn">The input item type.</typeparam>
/// <typeparam name="TField">The AI-generated field type.</typeparam>
public sealed class ChatEnrichmentOptionsBuilder<TIn, TField>
{
    ...
    public ChatEnrichmentOptionsBuilder<TIn, TField> WithSystemPrompt(string systemPrompt)
    {
    ...
    public ChatEnrichmentOptionsBuilder<TIn, TField> WithItemTemplate(Func<TIn, string> itemTemplate)
    {
    ...
    public ChatEnrichmentOptionsBuilder<TIn, TField> WithResultMapper(ResultMapper<TIn, TField> resultMapper)
    {
    ...
    public ChatEnrichmentOptionsBuilder<TIn, TField> WithTemperature(float temperature)
    {
    ...
    public ChatEnrichmentOptionsBuilder<TIn, TField> WithMaxOutputTokens(int maxOutputTokens)
    {
    ...
    public ChatEnrichmentOptionsBuilder<TIn, TField> WithNativeStructuredOutput(bool useNativeStructuredOutput = true)
    {
    ...
    public ChatEnrichmentOptionsBuilder<TIn, TField> WithConfigureOptions(Action<ChatOptions> configureOptions)
    {
    ...
    public ChatEnrichmentOptions<TIn, TField> Build()
    {
        ...
        return new ChatEnrichmentOptions<TIn, TField>(
            _systemPrompt,
            _itemTemplate,
            _resultMapper,
            _temperature,
