...
/// <summary>Configuration options for <see cref="Nodes.ChatTransformNode{TIn, TOut}" />.</summary>
...
/// <summary>Fluent builder for <see cref="ChatTransformOptions{TIn, TOut}" />.</summary>
/// <typeparam name="TIn">The input item type.</typeparam>
/// <typeparam name="TOut">The output item type.</typeparam>
public sealed class ChatTransformOptionsBuilder<TIn, TOut>
{
    ...
    public ChatTransformOptionsBuilder<TIn, TOut> WithSystemPrompt(string systemPrompt)
    {
    ...
    public ChatTransformOptionsBuilder<TIn, TOut> WithItemTemplate(Func<TIn, string> itemTemplate)
    {
    ...
    public ChatTransformOptionsBuilder<TIn, TOut> WithTemperature(float temperature)
    {
    ...
    public ChatTransformOptionsBuilder<TIn, TOut> WithMaxOutputTokens(int maxOutputTokens)
    {
    ...
    public ChatTransformOptionsBuilder<TIn, TOut> WithNativeStructuredOutput(bool useNativeStructuredOutput = true)
    {
    ...
    public ChatTransformOptionsBuilder<TIn, TOut> WithConfigureOptions(Action<ChatOptions> configureOptions)
    {
    ...
    public ChatTransformOptions<TIn, TOut> Build()
    {
        ...
        return new ChatTransformOptions<TIn, TOut>(
            _systemPrompt,
            _itemTemplate,
            _temperature,
            _maxOutputTokens,
