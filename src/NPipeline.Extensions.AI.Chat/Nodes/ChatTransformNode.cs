...
public sealed class ChatTransformNode<TIn, TOut> : TransformNode<TIn, TOut>
{
    ...
    public override async ValueTask<TOut> TransformAsync(TIn item, PipelineContext context, CancellationToken cancellationToken)
    {
        ...
        return await ChatInvoker.InvokeTransformAsync<TIn, TOut>(
            _chatClient,
            item,
