...
/// <summary>Configuration options for <see cref="Nodes.AIBatchedEnrichNode{TIn, TField}" />.</summary>
...
public sealed record AIBatchedEnrichOptions<TIn, TField>(
...
/// <summary>Fluent builder for <see cref="AIBatchedEnrichOptions{TIn, TField}" />.</summary>
/// <typeparam name="TIn">The input item type.</typeparam>
/// <typeparam name="TField">The AI-generated field type.</typeparam>
public sealed class AIBatchedEnrichOptionsBuilder<TIn, TField>
{
    ...
    public AIBatchedEnrichOptionsBuilder<TIn, TField> WithSystemPrompt(string systemPrompt)
    {
    ...
    public AIBatchedEnrichOptionsBuilder<TIn, TField> WithBatchTemplate(Func<IReadOnlyCollection<TIn>, string> batchTemplate)
    {
    ...
    public AIBatchedEnrichOptionsBuilder<TIn, TField> WithResultMapper(ResultMapper<TIn, TField> resultMapper)
    {
    ...
    public AIBatchedEnrichOptionsBuilder<TIn, TField> WithTemperature(float temperature)
    {
    ...
    public AIBatchedEnrichOptionsBuilder<TIn, TField> WithMaxOutputTokens(int maxOutputTokens)
    {
    ...
    public AIBatchedEnrichOptionsBuilder<TIn, TField> WithNativeStructuredOutput(bool useNativeStructuredOutput = true)
    {
    ...
    public AIBatchedEnrichOptionsBuilder<TIn, TField> WithConfigureOptions(Action<ChatOptions> configureOptions)
    {
    ...
    public AIBatchedEnrichOptions<TIn, TField> Build()
    {
        ...
        return new AIBatchedEnrichOptions<TIn, TField>(
            _systemPrompt,
            _batchTemplate,
            _resultMapper,
            _temperature,
