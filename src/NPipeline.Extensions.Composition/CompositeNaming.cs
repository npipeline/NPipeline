...
public static class CompositeNaming
{
    ...
    public static string PrefixNodeId(string parentNodeId, string childNodeId) => $"{parentNodeId}{Separator}{childNodeId}";
    ...
    public static bool IsNamespaced(string nodeId) => nodeId.Contains(Separator, StringComparison.Ordinal);
    ...
    public static string? GetParentNodeId(string namespacedNodeId)
    {
        ...
        return separatorIndex < 0
            ? null
            : namespacedNodeId[..separatorIndex];
    }
    ...
    public static string GetChildNodeId(string namespacedNodeId)
    {
        ...
        return separatorIndex < 0
            ? namespacedNodeId
            : namespacedNodeId[(separatorIndex + Separator.Length)..];
    }
}
