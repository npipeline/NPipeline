...
{
    public IDataStream<T> Initialize(PipelineContext context, CancellationToken cancellationToken)
    {
...
{
    public async Task ExecuteAsync(IDataStream<T> input, PipelineContext context, CancellationToken cancellationToken)
    {
