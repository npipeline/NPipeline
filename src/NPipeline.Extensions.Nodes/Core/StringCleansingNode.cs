...
public sealed class StringCleansingNode<T> : PropertyTransformationNode<T>
{
    ...
    {
        ArgumentNullException.ThrowIfNull(selector);
        Register(selector, value => value == null ? null : new string(value.Where(c => !char.IsWhiteSpace(c)).ToArray()));
        return this;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(selector);
        Register(selector, value => value == null ? null : CultureInfo.InvariantCulture.TextInfo.ToTitleCase(value.ToLowerInvariant()));
        return this;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(selector);
        Register(selector, value => value == null ? null : new string(value.Where(char.IsLetterOrDigit).ToArray()));
        return this;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(selector);
        Register(selector, value => value == null ? null : new string(value.Where(c => !char.IsDigit(c)).ToArray()));
        return this;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(selector);
        Register(selector, value => value == null ? null : new string(value.Where(c => c < 128).ToArray()));
        return this;
    }
    ...
    public StringCleansingNode<T> Truncate(Expression<Func<T, string?>> selector, int maxLength)
    {
        ...
        Register(selector, value => value == null ? null : (value.Length > maxLength ? value.Substring(0, maxLength) : value));
        return this;
    }
    ...
    public StringCleansingNode<T> EnsurePrefix(Expression<Func<T, string?>> selector, string prefix)
    {
        ...
        Register(selector, value => value == null ? null : (value.StartsWith(prefix, StringComparison.Ordinal) ? value : prefix + value));
        return this;
    }
    ...
    public StringCleansingNode<T> EnsureSuffix(Expression<Func<T, string?>> selector, string suffix)
    {
        ...
        Register(selector, value => value == null ? null : (value.EndsWith(suffix, StringComparison.Ordinal) ? value : value + suffix));
        return this;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(selector);
        Register(selector, value => string.IsNullOrWhiteSpace(value) ? null : value);
        return this;
    }
}
