...
public sealed class DiObservabilityFactory : IObservabilityFactory
{
    ...
    public IObservabilityCollector? ResolveObservabilityCollector() =>
        ...
        _serviceProvider.GetService<IObservabilityCollector>();
    ...
    public IMetricsSink? ResolveMetricsSink() => _serviceProvider.GetService<IMetricsSink>();
    ...
    public IPipelineMetricsSink? ResolvePipelineMetricsSink() => _serviceProvider.GetService<IPipelineMetricsSink>();
}
