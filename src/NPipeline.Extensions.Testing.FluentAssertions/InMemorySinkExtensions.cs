...
namespace NPipeline.Extensions.Testing.FluentAssertions;
...
public static class InMemorySinkExtensions
{
    ...
    public static PipelineExecutionResult ShouldBeSuccessful(this PipelineExecutionResult result)
    {
        ...
        _ = result.Success.Should().BeTrue("pipeline execution should succeed");
        return result;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(result);
        _ = result.Success.Should().BeFalse("pipeline execution should fail");
        return result;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(result);
        _ = result.Errors.Should().BeEmpty("no errors should be captured during execution");
        return result;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(result);
        _ = result.Errors.Should().HaveCount(expectedCount, $"exactly {expectedCount} error(s) should be captured");
        return result;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(result);
        _ = result.Errors.Should().ContainItemsAssignableTo<TException>($"at least one error of type {typeof(TException).Name} should be captured");
        return result;
    }
    ...
    {
        ArgumentNullException.ThrowIfNull(result);
        _ = result.Duration.Should().BeLessThanOrEqualTo(maxDuration, $"pipeline should complete within {maxDuration.TotalMilliseconds}ms");
        return result;
    }
}
