...
public static class ErrorCodes
{
    ...
    public const string IncompleteResilientConfiguration = "NP9002";
    ...
    public const string MissingDependencyInjection = "NP9409";
    ...
    /// <summary>Failed to extract items from ListDataPipe.</summary>
    public const string FailedToExtractItemsFromListDataPipe = "NP0308";
    ...
    public const string BlockingAsyncOperation = "NP9102";

    /// <summary>Detects catch blocks that may swallow OperationCanceledException without re-throwing it.</summary>
    public const string SwallowedOperationCanceledException = "NP9103";

    /// <summary>Synchronous method calling async operations without proper await.</summary>
    public const string SynchronousOverAsync = "NP9104";

    /// <summary>Detects nodes that don't properly respect cancellation tokens.</summary>
    public const string NodeNotRespectingCancellationToken = "NP9105";
    ...
    public const string MissingValueTaskOptimization = "NP9209";

    /// <summary>Source node is not streaming data properly.</summary>
    public const string SourceNodeNotStreamingData = "NP9211";
    ...
    public const string SinkNodeInputNotConsumed = "NP9312";
    ...
    public const string UnsafePipelineContextAccess = "NP9313";
