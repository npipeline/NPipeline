...
///     </para>
///     <para>
///         The cache is unbounded by default. For applications with many dynamic pipeline definitions,
///         consider implementing a custom cache with eviction policies or using a distributed cache.
///     </para>
/// </remarks>
public sealed class InMemoryPipelineExecutionPlanCache : IPipelineExecutionPlanCache
{
    private readonly ConcurrentDictionary<string, Dictionary<string, NodeExecutionPlan>> _cache = new();
        ...
        out Dictionary<string, NodeExecutionPlan>? cachedPlans)
    {
        ...
        return _cache.TryGetValue(cacheKey, out cachedPlans);
    }
        ...
        Dictionary<string, NodeExecutionPlan> plans)
    {
        ...
        _cache[cacheKey] = new Dictionary<string, NodeExecutionPlan>(plans);
    }
