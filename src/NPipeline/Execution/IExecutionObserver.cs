...
public sealed record NodeExecutionStarted(string NodeId, string NodeType, DateTimeOffset StartTime, string? PipelineName = null);
...
/// <param name="PipelineName">The logical pipeline name for the current execution context.</param>
public sealed record NodeRetryEvent(string NodeId, RetryKind Kind, int Attempt, Exception? LastException, string? PipelineName = null);
