...
/// </remarks>
internal static class LineageMappingHelpers
{
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static ImmutableList<LineageHop> MaybeAppendHop(ImmutableList<LineageHop> existing, string nodeId, LineageOptions? opts)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static ImmutableList<LineageHop> AppendHop(ImmutableList<LineageHop> existing, string nodeId, LineageOptions? opts, HopDecisionFlags outcome,
    ...
    internal static IEnumerable<LineagePacket<TOut>> MapMaterialized<TIn, TOut>(List<LineagePacket<TIn>> inputs, List<TOut> outputs, string nodeId,
    ...
    internal static async IAsyncEnumerable<LineagePacket<TOut>> PositionalStreamingMap<TIn, TOut>(IAsyncEnumerable<LineagePacket<TIn>> inAll,
