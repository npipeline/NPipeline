...
internal sealed class MaterializingStrategy<TIn, TOut> : ILineageMappingStrategy<TIn, TOut>
{
        ...
        [EnumeratorCancellation] CancellationToken ct)
    {
        ...
        foreach (var packet in LineageMappingHelpers.MapMaterialized(inputs, outputs, nodeId, cardinality, options, lineageMapperType,
                     mapperInstance))
        {
            yield return packet;
        }
