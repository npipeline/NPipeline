...
public enum MergeType
{
    ...
    ///     The input streams are read concurrently, so an unbounded live input does not starve the other side;
    ///     the output order across the two inputs is therefore not deterministic.
    /// </summary>
    KeyedJoin,
