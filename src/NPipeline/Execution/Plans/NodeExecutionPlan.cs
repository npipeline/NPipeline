...
///         cached plan always executes the node instances belonging to the current run.
///     </para>
///     <para>
...
public sealed record NodeExecutionPlan(
    ...
    Func<INode, IDataStream, PipelineContext, CancellationToken, Task<IDataStream>>? ExecuteTransform = null,
