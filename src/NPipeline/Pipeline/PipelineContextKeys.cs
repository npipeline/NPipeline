...
public static class PipelineContextKeys
{
    ...
    public static string ParallelMetrics(string nodeId) => $"parallel.metrics::{nodeId}";
    ...
    public static string ParallelMetricsOutputCapacity(string nodeId) => $"parallel.metrics.output.capacity::{nodeId}";
    ...
    public static string ParallelMetricsInputHighWater(string nodeId) => $"parallel.metrics.input.highwater::{nodeId}";
    ...
    public static string ParallelMetricsOutputHighWater(string nodeId) => $"parallel.metrics.output.highwater::{nodeId}";
    ...
    public static string ParallelMetricsRetryEvents(string nodeId) => $"parallel.metrics.retry.events::{nodeId}";
    ...
    public static string ParallelMetricsRetryItems(string nodeId) => $"parallel.metrics.retry.items::{nodeId}";
    ...
    public static string ParallelMetricsMaxItemRetryAttempts(string nodeId) => $"parallel.metrics.retry.maxItemAttempts::{nodeId}";
    ...
    public static string ParallelMetricsDroppedNewest(string nodeId) => $"parallel.metrics.dropped.newest::{nodeId}";
    ...
    public static string ParallelMetricsDroppedOldest(string nodeId) => $"parallel.metrics.dropped.oldest::{nodeId}";
    ...
    public static string ParallelMetricsEnqueued(string nodeId) => $"parallel.metrics.enqueued::{nodeId}";
    ...
    public static string ParallelMetricsProcessed(string nodeId) => $"parallel.metrics.processed::{nodeId}";
    ...
    public static string DiagnosticsResilienceFailures(string nodeId) => $"diag.resilience.{nodeId}.failures";
    ...
    public static string DiagnosticsResilienceThrowingOnFailure(string nodeId) => $"diag.resilience.{nodeId}.throwingOnFailure";
    ...
    public static string TestingSourceData(string nodeId) => $"NPipeline.Testing.SourceData::{nodeId}";
    ...
    public static string BranchMetricsForNode(string nodeId) => $"branch.metrics::{nodeId}";
}
