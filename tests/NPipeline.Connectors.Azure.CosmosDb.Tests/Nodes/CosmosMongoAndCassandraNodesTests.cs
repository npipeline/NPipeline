...
public sealed class CosmosMongoAndCassandraNodesTests
{
    ...
    public void CosmosMongoSourceNode_Initialize_ShouldReturnDataStream()
    {
        ...
        var pipe = node.OpenStream(PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public void CosmosCassandraChangeFeedSourceNode_Initialize_ShouldThrowNotSupportedException()
    {
        ...
        var act = () => node.OpenStream(PipelineContext.CreateDefault(), CancellationToken.None);
