...
#pragma warning restore CS0618
    ...
    {
        public void OnFileReadStarted(StorageUri fileUri)
        {
        }

        public void OnRowGroupRead(StorageUri fileUri, int rowGroupIndex, long rowCount)
        {
        }

        public void OnFileReadCompleted(StorageUri fileUri, long totalRows, long totalBytes, TimeSpan duration)
        {
        }

        public void OnRowMappingError(StorageUri fileUri, Exception exception)
        {
        }

        public void OnRowGroupWritten(StorageUri fileUri, int rowGroupIndex, long rowCount)
        {
        }

        public void OnFileWriteCompleted(StorageUri fileUri, long totalRows, long totalBytes, TimeSpan duration)
        {
        }
    }
