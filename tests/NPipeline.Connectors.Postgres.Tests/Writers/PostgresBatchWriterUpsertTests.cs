...
namespace NPipeline.Connectors.Postgres.Tests.Writers;
...
public sealed class PostgresBatchWriterUpsertTests
{
    ...
    private static readonly Type? BatchWriterType = PostgresAssembly.GetType("NPipeline.Connectors.Postgres.Writers.PostgresBatchWriter`1");
