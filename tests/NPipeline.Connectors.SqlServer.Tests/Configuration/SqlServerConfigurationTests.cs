...
public sealed class SqlServerConfigurationTests
{
    ...
    public void DefaultConfiguration_ShouldHaveValidDefaults()
    {
        ...
        config.Resilience.Should().BeSameAs(SqlServerConnectorResilience.Default);
    ...
    {
        // Arrange
        var config = new SqlServerConfiguration { Resilience = null! };
...
#pragma warning disable NRES003
        var config = new SqlServerConfiguration { Resilience = SqlServerConnectorResilience.Default with { Attempts = 0 } };
