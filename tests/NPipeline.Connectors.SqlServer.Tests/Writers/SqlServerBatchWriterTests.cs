...
/// <summary>
///     Tests for SqlServerBatchWriter.
///     Validates batch write operations, parameter mapping, and error handling.
/// </summary>
public sealed class SqlServerBatchWriterTests
{
    #region Test Models
    ...
    public void Constructor_WithValidParameters_CreatesWriter()
    {
        ...
        // Act
        var writer = new SqlServerBatchWriter<TestEntity>(
            connection,
            "dbo",
            "test_table",
            null,
    ...
    public void Constructor_WithNullConnection_ThrowsArgumentNullException()
    {
        ...
        // Act
        var action = () => new SqlServerBatchWriter<TestEntity>(
            null!,
            "dbo",
            "test_table",
            null,
    ...
    public void Constructor_WithCustomBatchSize_UsesBatchSize()
    {
        // Arrange
        var connection = A.Fake<IDatabaseConnection>();
        var configuration = new SqlServerConfiguration { BatchSize = 100 };
    ...
    public async Task WriteAsync_WithValidItem_BuffersItem()
    {
        // Arrange
        var connection = A.Fake<IDatabaseConnection>();
        var configuration = new SqlServerConfiguration { BatchSize = 10 };
    ...
    public async Task WriteAsync_WithBatchSizeReached_FlushesBatch()
    {
        ...
        var configuration = new SqlServerConfiguration { BatchSize = 2 };
    ...
    public async Task WriteAsync_WithCustomParameterMapper_UsesMapper()
    {
        ...
        var connection = A.Fake<IDatabaseConnection>();
        var command = A.Fake<IDatabaseCommand>();
        var configuration = new SqlServerConfiguration { BatchSize = 1 };
        ...
        var writer = new SqlServerBatchWriter<TestEntityWithMapper>(
            connection,
            "dbo",
            "test_table",
            mapper,
    ...
    public async Task WriteAsync_WithCommandTimeout_SetsTimeout()
    {
        ...
        var connection = A.Fake<IDatabaseConnection>();
        var command = A.Fake<IDatabaseCommand>();
        var configuration = new SqlServerConfiguration { BatchSize = 1, CommandTimeout = 60 };
    ...
    public async Task WriteAsync_WithCancellation_CancelsOperation()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<TaskCanceledException>(() => writer.WriteAsync(item, cts.Token));
    }
    ...
    public async Task WriteBatchAsync_WithCancellation_CancelsOperation()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<TaskCanceledException>(() => writer.WriteBatchAsync(items, cts.Token));
    }
    ...
    public async Task FlushAsync_WithCancellation_CancelsOperation()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<TaskCanceledException>(() => writer.FlushAsync(cts.Token));
    }
