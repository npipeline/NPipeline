...
/// <summary>
///     Tests for exactly-once delivery semantics in SQL Server connector.
...
public sealed class SqlServerExactlyOnceTests
{
    ...
    #region UseTransaction Configuration Tests

    [Fact]
    public void UseTransaction_DefaultValue_IsTrue()
    {
        // Arrange & Act
        var configuration = new SqlServerConfiguration();
    ...
    [Fact]
    public void UseTransaction_CanBeSetToFalse()
    {
        // Arrange & Act
        var configuration = new SqlServerConfiguration
        {
    ...
    [Fact]
    public void UseTransaction_CanBeSetToTrue()
    {
        // Arrange & Act
        var configuration = new SqlServerConfiguration
        {
    ...
    [Fact]
    public void Configuration_WithExactlyOnceAndValidSettings_ValidatesSuccessfully()
    {
        // Arrange
        var configuration = new SqlServerConfiguration
        {
    ...
    [Fact]
    public void Configuration_WithAtLeastOnceAndNoTransaction_ValidatesSuccessfully()
    {
        // Arrange
        var configuration = new SqlServerConfiguration
        {
