...
public class ChatBatchedEnrichmentNodeTests
{
    [Fact]
    public async Task TransformAsync_BareArrayResponse_ForSingleItemBatch_IsWrappedAndDeserialized()
    {
        ...
        var node = new ChatBatchedEnrichmentNode<TestDomain.Comment, TestDomain.SentimentResult>(client)
        {
            Options = new ChatBatchedEnrichmentOptions<TestDomain.Comment, TestDomain.SentimentResult>(
                "Analyze.",
                _ => "analyze",
