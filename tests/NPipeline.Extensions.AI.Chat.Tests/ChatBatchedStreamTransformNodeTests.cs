...
public class ChatBatchedStreamTransformNodeTests
{
    [Fact]
    public void DefaultExecutionStrategy_IsStreamCapable()
    {
        var node = new ChatBatchedStreamTransformNode<TestDomain.Comment, TestDomain.ClassificationResult>(FakeChatClient.ThatReturns("[]"));
    ...
    public async Task TransformAsync_MultipleBatches_ReturnsAllResults()
    {
        ...
        var node = new ChatBatchedStreamTransformNode<TestDomain.Comment, TestDomain.ClassificationResult>(client)
        {
            Options = new ChatBatchedStreamTransformOptions<TestDomain.Comment, TestDomain.ClassificationResult>(
                "Classify.",
                batch => "classify",
                BatchSize: 2),
        };
    ...
    [Fact]
    public async Task TransformAsync_CountMismatch_ThrowsChatTransformException()
    {
        var client = FakeChatClient.ThatReturns(
    ...
    [Fact]
    public async Task TransformAsync_ErrorInBatch_ThrowsChatTransformException()
    {
