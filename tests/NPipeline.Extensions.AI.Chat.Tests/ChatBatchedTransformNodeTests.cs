...
public class ChatBatchedTransformNodeTests
{
    [Fact]
    public async Task TransformAsync_BareArrayResponse_ForSingleItemBatch_IsWrappedAndDeserialized()
    {
        ...
        var node = new ChatBatchedTransformNode<TestDomain.Comment, TestDomain.ClassificationResult>(client)
        {
            Options = new ChatBatchedTransformOptions<TestDomain.Comment, TestDomain.ClassificationResult>(
                "Classify each item.",
