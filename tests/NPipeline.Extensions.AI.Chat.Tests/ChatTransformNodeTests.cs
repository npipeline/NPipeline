...
public class ChatTransformNodeTests
{
    [Fact]
    ...
    [Fact]
    public async Task TransformAsync_InvalidJson_ThrowsChatTransformException()
    {
    ...
    [Fact]
    public async Task TransformAsync_JsonNullLiteral_ThrowsChatTransformException()
    {
    ...
    [Fact]
    public async Task TransformAsync_ItemTemplateThrows_WrapsInChatTransformException()
    {
        var client = FakeChatClient.ThatReturns("""{"category":"X","confidence":0.5}""");

        var node = new ChatTransformNode<TestDomain.Comment, TestDomain.ClassificationResult>(client)
        {
    ...
    [Fact]
    public async Task TransformAsync_ConfigureOptionsThrows_WrapsInChatTransformException()
    {
        var client = FakeChatClient.ThatReturns("""{"category":"X","confidence":0.5}""");
    ...
    {
        Assert.Throws<ArgumentNullException>(() => new ChatTransformNode<TestDomain.Comment, TestDomain.ClassificationResult>(null!));
    }

    private static ChatTransformNode<TestDomain.Comment, TestDomain.ClassificationResult> CreateNode(IChatClient client)
    {
