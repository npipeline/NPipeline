...
public sealed class TypeConversionNodeTests
{
    ...
    public async Task ExecuteAsync_WithCancelledToken_Throws()
    {
        ...
        await Assert.ThrowsAsync<OperationCanceledException>(() =>
            node.TransformAsync("42", PipelineContext.CreateDefault(), cts.Token).AsTask());
    }
    ...
    {
        var node = TypeConversions.StringToInt();
        var result = await node.TransformAsync("42", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    {
        var node = TypeConversions.StringToInt();
        var result = await node.TransformAsync(input, PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task StringToInt_WithNullOrWhitespace_Throws(string input)
    {
        ...
        await Assert.ThrowsAsync<TypeConversionException>(() =>
            node.TransformAsync(input, PipelineContext.CreateDefault(), CancellationToken.None).AsTask());
    }
    ...
    public async Task StringToLong_WithValidString_Converts()
    {
        ...
        var result = await node.TransformAsync("9223372036854775807", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task StringToDouble_WithValidString_Converts()
    {
        ...
        var result = await node.TransformAsync("42.5", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task StringToDateTime_WithValidString_Converts()
    {
        ...
        var result = await node.TransformAsync("2025-01-15 14:30:00", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task StringToDateTime_WithSpecificFormat_Converts()
    {
        ...
        var result = await node.TransformAsync("2025-01-15", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task DoubleToString_WithFormat_Converts()
    {
        ...
        var result = await node.TransformAsync(42.567, PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task DecimalToString_WithValue_Converts()
    {
        ...
        var result = await node.TransformAsync(42.5m, PipelineContext.CreateDefault(), CancellationToken.None);
        Assert.Equal("42.5", result);
    }
    ...
    public async Task BoolToString_WithTrue_Converts()
    {
        ...
        var result = await node.TransformAsync(true, PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    {
        var node = TypeConversions.BoolToString();
        var result = await node.TransformAsync(false, PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task EnumToString_WithValue_Converts()
    {
        ...
        var result = await node.TransformAsync(TestValues.Value1, PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task StringToEnum_WithValidString_Converts()
    {
        ...
        var result = await node.TransformAsync("Value1", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task StringToEnum_WithCaseSensitive_ThrowsForWrongCase()
    {
        ...
        await Assert.ThrowsAsync<TypeConversionException>(() =>
            node.TransformAsync("value1", PipelineContext.CreateDefault(), CancellationToken.None).AsTask());
    }
    ...
    public async Task WithConverter_UsesCustomFunction_Converts()
    {
        ...
        var result = await node.TransformAsync("hello", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task WithConverter_WhenNotSet_Throws()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            node.TransformAsync("test", PipelineContext.CreateDefault(), CancellationToken.None).AsTask());
    }
    ...
    [Fact]
    public async Task TransformAsync_WithStringToInt_ReturnsValue()
    {
        var node = TypeConversions.StringToInt();
        var result = await node.TransformAsync("42", PipelineContext.CreateDefault(), CancellationToken.None);
        Assert.Equal(42, result);
    ...
    [Fact]
    public async Task TransformAsync_WithInvalidInput_Throws()
    {
        var node = TypeConversions.StringToInt();

        await Assert.ThrowsAsync<TypeConversionException>(async () =>
            await node.TransformAsync("not a number", PipelineContext.CreateDefault(), CancellationToken.None));
    }
    ...
    public async Task StringToInt_OnFailure_IncludesSourceAndTargetTypes()
    {
        ...
        var ex = await Assert.ThrowsAsync<TypeConversionException>(() =>
            node.TransformAsync("not a number", PipelineContext.CreateDefault(), CancellationToken.None).AsTask());
    ...
    public async Task Chaining_StringToInt_ThenIntToString_Roundtrips()
    {
        ...
        var intResult = await stringToInt.TransformAsync("42", PipelineContext.CreateDefault(), CancellationToken.None);
        var stringResult = await intToString.TransformAsync(intResult, PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    public async Task Chaining_StringToDouble_ThenDoubleToString_Roundtrips()
    {
        ...
        var doubleResult = await stringToDouble.TransformAsync("42.5", PipelineContext.CreateDefault(), CancellationToken.None);
        var stringResult = await doubleToString.TransformAsync(doubleResult, PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    {
        var node = TypeConversions.StringToInt();
        var result = await node.TransformAsync(int.MaxValue.ToString(), PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    {
        var node = TypeConversions.StringToInt();
        var result = await node.TransformAsync(int.MinValue.ToString(), PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    {
        var node = TypeConversions.StringToDouble();
        var result = await node.TransformAsync("Infinity", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    {
        var node = TypeConversions.StringToDouble();
        var result = await node.TransformAsync("NaN", PipelineContext.CreateDefault(), CancellationToken.None);
    ...
    {
        var node = TypeConversions.DateTimeToString();
        var result = await node.TransformAsync(DateTime.MinValue, PipelineContext.CreateDefault(), CancellationToken.None);
        Assert.NotEmpty(result);
    }
    ...
    {
        var node = TypeConversions.DateTimeToString();
        var result = await node.TransformAsync(DateTime.MaxValue, PipelineContext.CreateDefault(), CancellationToken.None);
        Assert.NotEmpty(result);
    }
