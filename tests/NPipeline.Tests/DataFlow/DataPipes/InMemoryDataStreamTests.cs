...
public sealed class InMemoryDataPipeTests
{
    ...
    public async Task Enumeration_AfterDisposeAsync_DoesNotThrow()
    {
        ...
        {
            // This should not throw since InMemoryDataStream doesn't track disposal
        }

        // Note: InMemoryDataStream doesn't track disposal state, so this test documents current behavior
    }
