...
public sealed class KeyedJoinNodeTests
{
    ...
    {
        public override IDataPipe<Employee> ExecuteAsync(PipelineContext context, CancellationToken cancellationToken)
        {
            var employees = new[]
            {
    ...
    {
        public override IDataPipe<PayStub> ExecuteAsync(PipelineContext context, CancellationToken cancellationToken)
        {
            var payStubs = new[]
            {
